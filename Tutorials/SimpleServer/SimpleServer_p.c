...
typedef struct _SimpleServer_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } SimpleServer_MIDL_TYPE_FORMAT_STRING;

typedef struct _SimpleServer_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } SimpleServer_MIDL_PROC_FORMAT_STRING;

typedef struct _SimpleServer_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } SimpleServer_MIDL_EXPR_FORMAT_STRING;
...
extern const SimpleServer_MIDL_TYPE_FORMAT_STRING SimpleServer__MIDL_TypeFormatString;
extern const SimpleServer_MIDL_PROC_FORMAT_STRING SimpleServer__MIDL_ProcFormatString;
extern const SimpleServer_MIDL_EXPR_FORMAT_STRING SimpleServer__MIDL_ExprFormatString;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IMessageBox_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IMessageBox_ProxyInfo;
...
static const SimpleServer_MIDL_PROC_FORMAT_STRING SimpleServer__MIDL_ProcFormatString =
    {
        0,
        {
...
static const SimpleServer_MIDL_TYPE_FORMAT_STRING SimpleServer__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IMessageBox, ver. 0.0,
   GUID={0x59371D05,0x3025,0x4E52,{0xAF,0x88,0x97,0x7B,0x21,0x9F,0x0E,0x97}} */

#pragma code_seg(".orpc")
static const unsigned short IMessageBox_FormatStringOffsetTable[] =
    {
    0
    };

static const MIDL_STUBLESS_PROXY_INFO IMessageBox_ProxyInfo =
    {
    &Object_StubDesc,
    SimpleServer__MIDL_ProcFormatString.Format,
    &IMessageBox_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IMessageBox_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    SimpleServer__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(4) _IMessageBoxProxyVtbl = 
{
    &IMessageBox_ProxyInfo,
    &IID_IMessageBox,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* IMessageBox::Show */
};

const CInterfaceStubVtbl _IMessageBoxStubVtbl =
{
    &IID_IMessageBox,
    &IMessageBox_ServerInfo,
    4,
    0, /* pure interpreted */
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    SimpleServer__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _SimpleServer_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IMessageBoxProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _SimpleServer_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IMessageBoxStubVtbl,
    0
};

PCInterfaceName const _SimpleServer_InterfaceNamesList[] = 
{
    "IMessageBox",
    0
};
...
#define _SimpleServer_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SimpleServer, pIID, n)

int __stdcall _SimpleServer_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_SimpleServer_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo SimpleServer_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SimpleServer_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SimpleServer_StubVtblList,
    (const PCInterfaceName * ) & _SimpleServer_InterfaceNamesList,
    0, /* no delegation */
    & _SimpleServer_IID_Lookup, 
    1,
    2,
